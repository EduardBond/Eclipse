...
lblNameColor.setHorizontalAlignment(SwingConstants.CENTER);
lblNameColor.setBounds(105,143,175,24);
...
btnChangeColor.setBounds(116, 80, 207, 62);
contentPane.add(btnChangeColor);


lblNameColor.setBounds(129, 177, 174, 14);
contentPane.add(lblNameColor);
}
}